(() => {
  ...
  // extensions/pickup-point-custom-field/node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/components/BlockSpacer/BlockSpacer.mjs
...
${errorInfo.componentStack}`);
  ...
  // extensions/pickup-point-custom-field/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/components/BlockSpacer/BlockSpacer.mjs
  ...
  // extensions/pickup-point-custom-field/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/buyer-journey.mjs
  ...
  var Checkout_default = reactExtension("purchase.checkout.pickup-point-list.render-after", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {}));
  function Extension() {
    const applyAttributeChange = useApplyAttributeChange();
    const translate = useTranslate();
    const { settings } = useApi();
    const [name, setName] = (0, import_react15.useState)("");
    const [lastName, setLastName] = (0, import_react15.useState)("");
    const [number, setNumber] = (0, import_react15.useState)("");
    const [nameError, setNameError] = (0, import_react15.useState)("");
    const [lastNameError, setLastNameError] = (0, import_react15.useState)("");
    const [numberError, setNumberError] = (0, import_react15.useState)("");
    const prevValues = (0, import_react15.useRef)({ name: "", lastName: "", number: "" });
          ...
          return {
            ...
            perform: (result) => {
              if (result.behavior === "block") {
                if (!isNameSet())
                  setNameError(translate("nameerror"));
                if (!isLastNameSet())
                  setLastNameError(translate("lastnameerror"));
                if (!isNumberSet())
                  setNumberError(translate("numbererror"));
              }
            }
          };
        }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "base", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "bold", size: "large", children: settings.current.pickup_fields_heading }),
